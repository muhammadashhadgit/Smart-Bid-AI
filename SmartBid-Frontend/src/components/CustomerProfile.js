...
function CustomerProfile() {
  ...
  useEffect(() => {
    console.log("butt new debug:", userID);
    axios
      .post("http://localhost:8000/user/viewprofile", {
        userID: userID,
      })
  ...
  function deleteAccount() {
    axios
      .post("http://localhost:8000/user/deleteaccount", {
  ...
  function done() {
    if (Object.keys(user).length > 1) {
      axios
        .post("http://localhost:8000/user/editprofile", user)
        .then(function (res) {
    ...
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText
            ...
            style={{ fontSize: 15 }}
          >
            Are you sure you want to delete your account? You may have on-going
            auctioned products. Click Delete to confirm
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
      ...
      >
        ...
        >
          ...
          >
            {cust.firstName?.substring(0, 1)}
            {cust.lastName?.substring(0, 1)}
          </Avatar>
          <h1
            style={{
              textAlign: "left",
