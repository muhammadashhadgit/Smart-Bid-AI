  ...
  React.useEffect(() => {
    if (props.title === "Featured Products") {
      ...
      if(userID != null){
        ...
        axios
        .get("http://localhost:8000/product/recommendations",{params: {id :userID}})
        .then(function (res) {
          console.log("in featured products recommendations");
          console.log(res.data.recommendations);
          setDataprops(res.data.recommendations);
          setDataCheck(true);
        }, dataprops)
        .catch(function (err) {
          console.log(err);
        ...
        console.log("id access in feature product is : "+userID)
        axios
      ...
      axios
        .post("http://localhost:8000/product/category", {
  ...
  return (
    <div>
      ...
      <Box sx={{ display: "flex", overflowY: "auto" }}>
        ...
        >
          <img
            style={{ maxWidth: "100%", maxHeight: "100%", paddingRight: "5%" }}
            src="221.jpg"
            alt="advert"
          />
        </div>
