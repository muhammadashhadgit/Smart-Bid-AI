    ...
    onSubmit: (values) => {
      ...
      axios
        ...
        .then(function (response) {
          ...
          if (response.data.message === "success") {
            navigate("/Search", {
              state: { data: response.data, admin: false },
            });
          } else {
      ...
      <AppBar position="fixed" sx={{ backgroundColor: "black" }}>
        <Toolbar>
          <Link
            reloadDocument
            to={{ pathname: "/" }}
            style={{ margin: "0 15px", color: "#a7ac38" }}
          >
            <Logo
          ...
          <Menu
            ...
            onClose={handleClose}
          >
            <MenuItem id="profile-id" onClick={viewprofile}>
              Profile
            </MenuItem>
            <MenuItem id="wallet-id" onClick={wallet}>
              Wallet
            </MenuItem>
